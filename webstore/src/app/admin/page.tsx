...
const DashboardCard = ({ title, value, icon: Icon, color, trend }: { title: string, value: string, icon: any, color: string, trend?: string }) => (
  ...
  return (
    <div className="py-12 px-10 max-w-7xl mx-auto">
        <div className="mb-12 flex items-center justify-between">
            <div>
                ...
                <p className="text-slate-500 font-medium text-sm mt-2 flex items-center gap-2">
                    ...
                    Last database sync: <span className="font-bold text-slate-700">2 minutes ago</span>
                </p>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            <DashboardCard title="Catalog Size" value="84,204" icon={Library} color="bg-blue-600" trend="+1.2%" />
            <DashboardCard title="Active Titles" value="12" icon={Gamepad2} color="bg-emerald-600" />
            <DashboardCard title="Market Value" value="$1.4M" icon={TrendingUp} color="bg-indigo-600" trend="+4.5%" />
